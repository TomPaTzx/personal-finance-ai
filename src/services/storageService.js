...
export const INITIAL_DATA = {
  accounts: [
    ...
    {
      id: 'COOP-SAVINGS',
      name: 'บัญชีสหกรณ์ออมทรัพย์ (ที่ทำงานเก่าแม่)',
      bank: 'สหกรณ์ออมทรัพย์',
      category: 'EMERGENCY_VAULT',
      purpose: 'กองทุนเงินสำรองฉุกเฉินชีวิตของตัวเอง (เคยมี ฿100,000 ปัจจุบันเหลือ ฿4,000 ภารกิจกอบกู้คืนสู่ ฿100K)',
      balance: 4000,
      currency: 'THB',
      updatedAt: new Date().toISOString()
    },
  ...
  debts: [
    ...
    {
      id: 'SPAY-01',
      itemName: 'WH-1000XM6 หูฟังไร้สาย บลูทูธ Sony',
      owner: 'พี่แพร',
      category: 'GADGET',
      ...
      note: 'พี่แพรงวดสุดท้าย [5/5] โอนคืนเรา ฿2,074.49 (หมดหนี้ตัวนี้ทันทีหลัง ต.ค.!)'
    },
    {
      id: 'SPAY-02',
      itemName: 'LOGITECH G29 G923 DRIVING พวงมาลัยแข่งรถ',
      owner: 'ตัวเอง',
      category: 'GAMING',
      totalAmount: 6806.16,
    ...
    {
      id: 'SPAY-03',
      itemName: 'ชุดเกียร์ LOGITECH DRIVING FORCE',
      owner: 'ตัวเอง',
      category: 'GAMING',
      totalAmount: 1368,
    ...
    {
      id: 'SPAY-04',
      itemName: 'Bewell Ergo-multi Pillow Set เซตหมอนเออร์โก',
      owner: 'ตัวเอง/บ้าน',
      category: 'HEALTH',
      totalAmount: 2898.36,
    ...
    {
      id: 'SPAY-05',
      itemName: 'CUKTECH TA1406U แท่นชาร์จ 140W',
      owner: 'ตัวเอง',
      category: 'GADGET',
      totalAmount: 3181.75,
      ...
      status: 'ACTIVE',
      createdAt: '2026-05-01',
      note: 'งวดสุดท้าย [5/5] (หมดหนี้ตัวนี้ทันทีหลัง ต.ค.!)'
    },
    {
      id: 'SPAY-07',
      itemName: 'Sonoff NSPanel Pro 120 สวิตช์ไฟอัจฉริยะ',
      owner: 'บ้าน',
      category: 'SMARTHOME',
      totalAmount: 3316.08,
    ...
    {
      id: 'SPAY-08',
      itemName: 'Vexxo ปลั๊กไฟ Studio 8Outlet 8Switch',
      owner: 'บ้าน/ทำงาน',
      category: 'EQUIPMENT',
      totalAmount: 1329.00,
    ...
    {
      id: 'SPAY-09',
      itemName: 'TUYA ทูย่าโคมเพดานอัจฉริยะ WiFi 24W',
      owner: 'บ้าน',
      category: 'SMARTHOME',
      totalAmount: 865.44,
